              ...
              {navItems.map((item) => (
                <Link
                  ...
                  className={`font-primary font-medium text-[14px] relative text-white transition-colors duration-300 hover:text-white/70
                    ...
                    after:transition-[width] after:duration-300 ${item.label === 'FAQ' ? 'after:w-full' : 'after:w-0 hover:after:w-full'}`}
                >
                  {item.label}
                </Link>
              ))}
...
const faqItems = [
  ...
  { q: 'How can I contact customer support?', a: 'You can reach our customer support team via our <b>email address (<a href="mailto:contact@beyond-peptides.com" class="text-[#0a9edd] hover:underline">contact@beyond-peptides.com</a>)</b>. We are also working on providing support through <b>WhatsApp</b> in the near future.' },
