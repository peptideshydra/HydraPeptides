...
function OrderRow({ order, onStatusChange }: { order: OrderWithItems; onStatusChange: (id: string, status: string) => void }) {
...
export default function AdminOrdersPage() {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-[24px] font-bold text-white font-primary">Orders</h1>
        <p className="text-[14px] text-[#6B7785] font-primary mt-1">{orders.length} orders</p>
      </div>
