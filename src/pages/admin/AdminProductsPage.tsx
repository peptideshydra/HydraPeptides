  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-[24px] font-bold text-white font-primary">Products</h1>
          <p className="text-[14px] text-[#6B7785] font-primary mt-1">{products.length} products</p>
        </div>
        <Link
          to="/admin/products/new"
          className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-[#16A1C5] text-white font-primary font-semibold text-[14px] hover:bg-[#1291b3] transition-colors"
        >
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-[#2a2d37] overflow-hidden">
